...
$container = get_theme_mod( 'understrap_container_type' );
	...
	<div class="<?php echo esc_attr( $container ); ?>" id="wrapper-static-content" tabindex="-1">
		<div class="page-section">
			...
			<div class="row section-benefits row-cols-md-5">
						...
						<div class="single-benefit">
							<div class="benefit-icon">
								<div class="avis-verifies-testimonials">
									<img class="img-fluid" src="<?php echo get_template_directory_uri(); ?>/img/avis-verifies.svg"  width="150"/>
				...
				<div class="col-md px-0 py-md-4 before-last">
					<a href="https://maitredufour.com/cabinet-maitre-dufour-avocat-permis-de-conduire/">
						<div class="single-benefit">
							<div class="benefit-icon">
